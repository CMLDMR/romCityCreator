...
size_t Delaunator::get_interior_point(size_t e_a)
{
    return triangles[next_halfedge(next_halfedge(e_a))];
}
...
size_t Delaunator::hash_key(double x, double y) const
{
...
void Delaunator::Delaunator::link(size_t a, size_t b)
{
