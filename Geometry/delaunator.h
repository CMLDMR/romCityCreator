#ifndef DELAUNATOR_DELAUNATOR_H
#define DELAUNATOR_DELAUNATOR_H
...
public:
    ...
    double edge_length(size_t e_a);
    size_t get_interior_point(size_t e_a);
